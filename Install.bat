...
if %errorlevel% == 0 ( 
  ...
  msg * "This Bypass Is Made And Developed By Lucian And Modder.lol"
  ...
  curl -LJO https://github.com/iwannet/Projects/releases/latest/download/LanschoolAir_Blocker.bat > nul
  ...
  curl -LJO https://github.com/iwannet/Projects/releases/latest/download/update.bat > nul
  move "update.bat" "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\update.bat" > nul
  
  curl -LJO https://github.com/iwannet/Projects/releases/latest/download/run.vbs > nul
  ...
  msg * "Wi-Fi is not connected, Please Connect wifi to install LanschoolAir Blocker" 
  timeout /t 5 > nul
  goto wifi 
) 
